...
[**Report a vulnerability**](https://github.com/hassio-addons/app-freshrss/security/advisories/new)
...
- Issues only reproducible on releases older than the latest released version
  of this app.
- Issues in FreshRSS itself; please report those directly to the
  [FreshRSS project](https://github.com/FreshRSS/FreshRSS/security/policy).
- Exposure of the app to untrusted networks. The app is served through Home
  Assistant ingress and assumes the Home Assistant instance it runs on is
  trusted. Publishing the app's port is opt-in, and puts FreshRSS' own login
  in front of it.

## Scope

This security policy covers the FreshRSS app distributed by the Home
